"use strict";exports.id=554,exports.ids=[554],exports.modules={3592:(e,t,a)=>{a.d(t,{Z:()=>l});var n=a(6689);let r=e=>e.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),s=(...e)=>e.filter((e,t,a)=>!!e&&""!==e.trim()&&a.indexOf(e)===t).join(" ").trim();var i={xmlns:"http://www.w3.org/2000/svg",width:24,height:24,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"};let o=(0,n.forwardRef)(({color:e="currentColor",size:t=24,strokeWidth:a=2,absoluteStrokeWidth:r,className:o="",children:l,iconNode:d,...p},g)=>(0,n.createElement)("svg",{ref:g,...i,width:t,height:t,stroke:e,strokeWidth:r?24*Number(a)/Number(t):a,className:s("lucide",o),...p},[...d.map(([e,t])=>(0,n.createElement)(e,t)),...Array.isArray(l)?l:[l]])),l=(e,t)=>{let a=(0,n.forwardRef)(({className:a,...i},l)=>(0,n.createElement)(o,{ref:l,iconNode:t,className:s(`lucide-${r(e)}`,a),...i}));return a.displayName=`${e}`,a}},7663:(e,t,a)=>{a.d(t,{Z:()=>n});let n=(0,a(3592).Z)("BookOpen",[["path",{d:"M12 7v14",key:"1akyts"}],["path",{d:"M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z",key:"ruj8y"}]])},2972:(e,t,a)=>{a.d(t,{Z:()=>n});let n=(0,a(3592).Z)("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]])},4550:(e,t,a)=>{a.a(e,async(e,n)=>{try{a.d(t,{Z:()=>d});var r=a(997);a(6689);var s=a(6197),i=a(2972),o=a(7434),l=e([s,o]);[s,o]=l.then?(await l)():l;let d=({isOpen:e,onClose:t,productName:a,rules:n})=>n?r.jsx(s.AnimatePresence,{children:e&&r.jsx(r.Fragment,{children:r.jsx(s.motion.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},onClick:t,className:"fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4",children:(0,r.jsxs)(s.motion.div,{initial:{opacity:0,scale:.95,y:20},animate:{opacity:1,scale:1,y:0},exit:{opacity:0,scale:.95,y:20},onClick:e=>e.stopPropagation(),className:"bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col",children:[(0,r.jsxs)("div",{className:"relative text-gray-800 p-6 md:p-8 flex items-center justify-between overflow-hidden",style:{background:"linear-gradient(to bottom right, rgba(180, 255, 200, 0.4), rgba(197, 223, 223, 0.5), rgba(62, 200, 188, 0.3))"},children:[r.jsx("h2",{className:"text-2xl md:text-4xl font-bold relative z-10",children:a}),r.jsx(o.z,{onClick:t,variant:"ghost",size:"icon",className:"text-gray-800 hover:bg-white/30 relative z-10",children:r.jsx(i.Z,{className:"h-6 w-6"})})]}),r.jsx("div",{className:"overflow-y-auto flex-1 p-6 md:p-8",children:r.jsx("div",{className:"prose prose-lg max-w-none",children:n.split("\n").map((e,t)=>{let a=/^[A-Z][A-Z\s&]+$/.test(e.trim())&&e.trim().length>3&&e.trim().length<50,n=e.trim().startsWith("•")||e.trim().startsWith("-");return""===e.trim()?r.jsx("div",{className:"h-4"},t):a?r.jsx("h3",{className:"text-2xl font-bold text-gray-900 mt-8 mb-4 first:mt-0",children:e.trim()},t):n||/^\d+\./.test(e.trim())?r.jsx("p",{className:"text-gray-700 mb-2 ml-4",children:e.trim()},t):r.jsx("p",{className:"text-gray-700 mb-4 leading-relaxed",children:e.trim()},t)})})}),r.jsx("div",{className:"border-t border-gray-200 p-6 bg-gray-50",children:r.jsx(o.z,{onClick:t,className:"w-full bg-orange-500 hover:bg-orange-600 text-white font-bold",size:"lg",children:"Sluiten"})})]})})})}):null;n()}catch(e){n(e)}})},7434:(e,t,a)=>{a.a(e,async(e,n)=>{try{a.d(t,{z:()=>m});var r=a(997),s=a(3514),i=a(4338),o=a(6926),l=a(6689),d=a.n(l),p=e([s,i,o]);[s,i,o]=p.then?(await p)():p;let g=(0,o.cva)("inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",{variants:{variant:{default:"bg-primary text-primary-foreground hover:bg-primary/90",destructive:"bg-destructive text-destructive-foreground hover:bg-destructive/90",outline:"border border-input bg-background hover:bg-accent hover:text-accent-foreground",secondary:"bg-secondary text-secondary-foreground hover:bg-secondary/80",ghost:"hover:bg-accent hover:text-accent-foreground",link:"text-primary underline-offset-4 hover:underline"},size:{default:"h-10 px-4 py-2",sm:"h-9 rounded-md px-3",lg:"h-11 rounded-md px-8",icon:"h-10 w-10"}},defaultVariants:{variant:"default",size:"default"}}),m=d().forwardRef(({className:e,variant:t,size:a,asChild:n=!1,...o},l)=>{let d=n?i.Slot:"button";return r.jsx(d,{className:(0,s.cn)(g({variant:t,size:a,className:e})),ref:l,...o})});m.displayName="Button",n()}catch(e){n(e)}})},328:(e,t,a)=>{a.d(t,{O:()=>n,V:()=>r});let n=[{id:"piramide",name:"PIRAMIDE TENNIS",category:"tennis",ageGroup:"Rood & Oranje (t/m 10-11 jaar)",description:"De strijd om de top \xe9n de actie! Daag spelers naast of boven je uit om te klimmen in de piramide. Het gaat niet alleen om wie bovenaan eindigt, maar ook om wie de meeste 'klimacties' maakt en de meeste wedstrijden speelt. Omdat elke gespeelde punt direct wordt bijgeschreven op jouw TOF score, is vaker spelen belangrijker dan winnen. Wat is jouw status vandaag?",detailedRules:`PIRAMIDE TENNIS
